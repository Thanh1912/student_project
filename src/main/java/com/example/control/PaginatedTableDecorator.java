...
public class PaginatedTableDecorator<T> {
    ...
    private PaginatedTableDecorator(TableModel tableModel, PaginationDataProvider<T> dataProvider,
    ...
    public static <T> PaginatedTableDecorator<T> decorate(TableModel tableModel,
                                                          PaginationDataProvider<T> dataProvider,
                                                          int[] pageSizes, int defaultPageSize) {
        PaginatedTableDecorator<T> decorator = new PaginatedTableDecorator<>(tableModel, dataProvider,
